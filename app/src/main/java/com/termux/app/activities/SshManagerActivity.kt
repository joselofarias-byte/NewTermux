...
private fun SshManagerScreen(
    ...
    // Dialog state
    var editorProfile by remember { mutableStateOf<SshProfile?>(null) } // profile being edited
    var showEditor by remember { mutableStateOf(false) }                // true while add/edit dialog open
